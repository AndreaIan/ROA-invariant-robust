function [info,g_LB,m_0_f,m_1_f,p_f] = JFI_ERA_StepA1_1(V_n,m_0,m_1,p,R_0,x,f,gopts)
...
sosconstr(4) = V_n - L2 - m_0 * (-t-R_0) >=0;
sosconstr(5) = - jacobian(V_n,x)*f - m_1 * (-t-R_0) >=0;
...
if ~isempty(info.tbnds)
    fprintf('\n Step A1-1 OK - optimal gamma found with bisection \n');
