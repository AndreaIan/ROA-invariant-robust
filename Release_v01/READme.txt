...
developed in the paper "Robust estimations of the region of attraction using invariant sets"
(currently under review in the Journal of The Franklin Institute).
